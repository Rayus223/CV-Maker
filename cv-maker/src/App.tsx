      ...
      {step === 'editor' && (
        <div className="flex flex-col h-screen">
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            {mobileView === 'form' && (
              <div className="md:hidden fixed left-0 top-20 flex flex-col bg-white shadow-md rounded-r-lg z-10">
                <div 
                  className={`p-2 cursor-pointer ${activeSection === 'about' ? 'text-brand-primary' : 'text-gray-400'}`}
                  onClick={() => setActiveSection('about')}
                >
                ...
                <div 
                  className={`p-2 cursor-pointer ${activeSection === 'education' ? 'text-brand-primary' : 'text-gray-400'}`}
                  onClick={() => setActiveSection('education')}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 14l9-5-9-5-9 5 9 5z" />
                ...
                <div 
                  className={`p-2 cursor-pointer ${activeSection === 'experience' ? 'text-brand-primary' : 'text-gray-400'}`}
                  onClick={() => setActiveSection('experience')}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                ...
                <div 
                  className={`p-2 cursor-pointer ${activeSection === 'projects' ? 'text-brand-primary' : 'text-gray-400'}`}
                  onClick={() => setActiveSection('projects')}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                ...
                <div 
                  className={`p-2 cursor-pointer ${activeSection === 'skills' ? 'text-brand-primary' : 'text-gray-400'}`}
                  onClick={() => setActiveSection('skills')}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
